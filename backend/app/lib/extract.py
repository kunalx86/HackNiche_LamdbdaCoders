...
def pdf_to_images(pdf_path):
    ...
    """
    print(os.getcwd(),"path3")
    print(pdf_path)
    pdf_name = os.path.splitext(os.path.basename(pdf_path))[0]
    images = convert_from_path(pdf_path, 200,poppler_path = 'C:\\Users\\rudra\\Downloads\\poppler-0.68.0_x86\\poppler-0.68.0\\bin')
